...
# ══════════════════════════════════════════
# [2026-09-12] 주식/quant_core.py와 정합성 유지용 — 이 백엔드에는 이 상수를 실제로 쓰는
# 코드 경로(12년 백테스트 day-loop, 가상포트폴리오)가 없어 정의만 동기화해둔다.
# ══════════════════════════════════════════
PYRAMID_ADD_TRIGGER_PCT = 5.0
PYRAMID_ADD_SIZE_RATIO  = 0.5
PYRAMID_MAX_ADDS        = 0
INDEX_OVERLAY_ENABLED = True
INDEX_OVERLAY_REGIMES = {"BULL"}
